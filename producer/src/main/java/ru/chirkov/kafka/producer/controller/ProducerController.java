package ru.chirkov.kafka.producer.controller;
...
import ru.chirkov.kafka.producer.service.MessageSender;
...
public class ProducerController {
    ...
    public void send(@RequestParam(required = false) Long messageId,
        ...
        messageSender.send(new KafkaMessage(messageId, messageValue));
    }
